...
class Formapagamento_model extends CI_Model
{
    ...
    public function conta_todos()
    {
        ...
        return $this->db->count_all_results('formaspagamento');
    }
    ...
    {
        if ($acao === 'criar') {
            $this->db->insert('formaspagamento', $dados);
        ...
        if ($acao === 'alterar') {
            ...
            return $this->db->update('formaspagamento', $dados);
        }
    }
    ...
    public function deletar($formapagamento_id)
    {
        ...
        return $this->db->delete('formaspagamento');
    }
}
