    ...
    <div class="col-12">
        ...
        <div class="tab-content">
            <div id="dados_gerais" class="tab-pane active">
                <form action="<?= base_url('entregadores/editar/salvar') ?>" method="post" class="j_send_form">
                    <div class="form-row">
                        <div class="form-group col-12 col-md-8">
                            <label for="entregador_nome">Nome</label>
                            <input type="text" name="entregador_nome" id="entregador_nome" class="form-control j_text_upper" value="<?= $entregador['entregador_nome'] ?>">
                        </div>
                        <div class="form-group col-12 col-md-4">
                            <label for="entregador_telefone">Telefone</label>
                            <input type="text" name="entregador_telefone" id="entregador_telefone" class="form-control j_mask_phone" value="<?= $entregador['entregador_telefone'] ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-12">
                        ...
                        <div class="form-group col-12">
                            <div class="custom-control custom-radio">
                                <input type="radio" name="entregador_status" id="status_yes" class="custom-control-input" value="A" <?= ($entregador['entregador_status'] === 'A') ? 'checked' : '' ?>>
                                <label for="status_yes" class="custom-control-label">Ativo</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" name="entregador_status" id="status_no" class="custom-control-input" value="I" <?= ($entregador['entregador_status'] === 'I') ? 'checked' : '' ?>>
                                <label for="status_no" class="custom-control-label">Inativo</label>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>">
                    <input type="hidden" name="entregador_id" value="<?= $entregador['entregador_id'] ?>">
                    <div class="row">
