...
<div class="row">
    <div class="col-12">
        <form action="<?= base_url('formaspagamento/cadastrar/salvar') ?>" method="post" class="j_send_form">
            <div class="form-row">
                <div class="form-group col-12">
                    <label for="formapagamento_descricao">Descrição</label>
                    <input type="text" name="formapagamento_descricao" id="formapagamento_descricao" class="form-control j_text_upper">
                </div>
            </div>
            <div class="form-row">
                <div class="col-12">
                ...
                <div class="form-group col-12">
                    <div class="custom-control custom-radio">
                        <input type="radio" name="formapagamento_status" id="status_yes" class="custom-control-input" value="A" checked>
                        <label for="status_yes" class="custom-control-label">Ativo</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input type="radio" name="formapagamento_status" id="status_no" class="custom-control-input" value="I">
